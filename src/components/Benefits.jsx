        ...
        <div className="container benefits__container">
          <div className="row benefits__row">
            <div className="benefits__top">
              <h1 className="benefits__title" data-aos="fade-up" data-aos-duration="1000">
                Professional driving instruction <br /> you can trust
              </h1>
              <h2 className="benefits__subheading" data-aos="fade-up" data-aos-duration="1050">
            ...
            <div className="benefits__bottom">
              <div className="benefits__blocks">
                <div className="benefits__block" data-aos="fade-up" data-aos-duration="1100">
                ...
                <div className="benefits__block" data-aos="fade-up" data-aos-duration="1150">
                ...
                <div className="benefits__block" data-aos="fade-up" data-aos-duration="1200">
              ...
              <span
                className="benefits__bottom-btn__wrapper"
                data-aos="fade-up"
